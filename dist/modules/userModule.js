...
var gradepoint_user_1 = require("../entities/gradepoint_user");
var getUsers = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userRepository = datasource_1.AppDataSource.getRepository(gradepoint_user_1.gradepoint_user);
...
var createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, userRepository, newUser;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, email = _a.email;
                userRepository = datasource_1.AppDataSource.getRepository(gradepoint_user_1.gradepoint_user);
                newUser = userRepository.create({ name: name, email: email });
